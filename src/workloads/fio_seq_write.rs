...
pub fn details() -> workloads::WorkloadDetails {
    workloads::fio_workload_details(
        "Sequential buffered write benchmark over a 1 GiB logical file space.",
        file!(),
        spec(),
    )
}

impl Workload for FioSeqWrite {
    ...
    fn description(&self) -> &'static str {
        "Sequential 4K write, 1 GB file (fio)"
    }
