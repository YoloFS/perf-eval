...
pub struct FioRandReadWarm;

pub fn spec() -> FioSpec {
    FioSpec {
        name: "fio-rand-read-warm",
        rw: "randread",
        warm_cache: true,
...
pub fn details() -> workloads::WorkloadDetails {
    workloads::fio_workload_details(
        "Random buffered read benchmark with warm page cache.",
        file!(),
        spec(),
    )
}

impl Workload for FioRandReadWarm {
    ...
    fn description(&self) -> &'static str {
        "Random 4K read, 1 GB file, warm page cache (fio)"
    }
