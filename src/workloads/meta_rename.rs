...
pub struct MetaRenameBase;
pub struct MetaRenameStage;
pub struct MetaRenameCheckpoint;

pub fn details_base() -> workloads::WorkloadDetails {
    workloads::workload_details(
        "Op benchmark for rename throughput on base-layer files.",
        &meta_shared::base_or_stage_fixture(MetaSource::Base, "10,000 files"),
        None,
        &meta_shared::execution_stub("crate::workloads::meta_shared::run_meta_rename(dest)?;"),
        file!(),
    )
}
...
pub fn details_stage() -> workloads::WorkloadDetails {
    workloads::workload_details(
        "Op benchmark for rename throughput on stage-local files.",
...
pub fn details_checkpoint() -> workloads::WorkloadDetails {
    workloads::workload_details(
        "Op benchmark for rename throughput on checkpoint-layer files.",
...
impl Workload for MetaRenameBase {
    ...
    fn description(&self) -> &'static str {
        "Rename 10,000 base-layer files"
    }
...
impl Workload for MetaRenameStage {
    fn name(&self) -> &'static str {
        "meta-rename-stage"
    }
    fn kind(&self) -> WorkloadKind {
    ...
    fn description(&self) -> &'static str {
        "Rename 10,000 stage-local files"
    }
    fn work_dir(&self) -> &'static str {
        "meta-rename-stage"
    }
...
impl Workload for MetaRenameCheckpoint {
    fn name(&self) -> &'static str {
        "meta-rename-checkpoint"
    }
    fn kind(&self) -> WorkloadKind {
        WorkloadKind::Op
    }
    fn description(&self) -> &'static str {
        "Rename 10,000 checkpoint-layer files"
    }
    fn work_dir(&self) -> &'static str {
        "meta-rename-checkpoint"
    }
